  ...
  return (
    <div className="w-full h-fit my-3 px-4">
      ...
      <div className="flex  items-center ">
        <Avatar />
        <h2 className="text-[20px] font-[800] ml-2 flex items-center">
          {displayName}
        </h2>
      ...
      <div className="w-full my-1 h-fit  flex flex-wrap items-center py-3 text-[18px] overflow-y-auto ">
        {text}
      </div>
      <div className="w-full flex items-center justify-evenly my-1">
        <button onClick={() => handleCommSec()}>
          <ChatBubbleOutline />
        </button>
        <button>
          <Repeat />
